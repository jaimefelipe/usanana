...
export class MenuComponent implements OnInit {
  ...
  clickCajaMenu(){
    this.CajaMenu = !this.CajaMenu;
    if(this.cajaClass == 'fa fa-arrow-left'){
      this.cajaClass = 'fa fa-arrow-right';
    }else{
      this.cajaClass = 'fa fa-arrow-left';
    }
  }
  clickHospedajeMenu(){
  ...
  async activateMenuOptions(){
    if(this.UserMenu.length > 0){
      ...
      if(this.Seguridad[7]==1){this.AppCaja=true}
