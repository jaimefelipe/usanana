...
export class MenuComponent implements OnInit {
  ...
  personaClass = 'fa fa-arrow-right';
  ...
  clickPersonaMenu(){
    this.PersonaMenu = !this.PersonaMenu;
    if(this.personaClass == 'fa fa-arrow-left'){
      this.personaClass = 'fa fa-arrow-right';
    }else{
      this.personaClass = 'fa fa-arrow-left';
    }
  }
  clickHospedajeMenu(){
  ...
  async activateMenuOptions(){
    if(this.UserMenu.length > 0){
      ...
      if(this.Seguridad[12]==1){this.AppPersona=true}
