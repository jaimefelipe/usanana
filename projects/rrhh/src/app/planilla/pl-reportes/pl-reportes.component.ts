...
@Component({
  selector: 'app-pl-reportes',
  templateUrl: './pl-reportes.component.html',
  styleUrls: ['./pl-reportes.component.css']
})
export class PlReportesComponent implements OnInit {
  constructor(
  ...
  Reporte(){
    ...
    if(this.reporte == "1"){
      ...
      window.open('https://toxo.work/reportes/rrhh/pl_reporte_horas.php?id=' + param, '_blank');
    }
    if(this.reporte == "2"){
      //window.open('https://toxo.work/reportes/bar/reporte-facturacion-venta-xls.php?id=' + param, '_blank');
      window.open('https://toxo.work/reportes/rrhh/pl_reporte_horas_dia.php?id=' + param, '_blank');
    }
    if(this.reporte == "3"){
      //window.open('https://toxo.work/reportes/bar/reporte-facturacion-venta-xls.php?id=' + param, '_blank');
      window.open('https://toxo.work/reportes/rrhh/pl_reporte_horas_resumen-empresa.php?id=' + param, '_blank');
    }
    if(this.reporte == "4"){
      //window.open('https://toxo.work/reportes/bar/reporte-facturacion-venta-xls.php?id=' + param, '_blank');
      window.open('https://toxo.work/reportes/rrhh/pl_reporte_horas_total.php?id=' + param, '_blank');
    }
