...
export class ProySchedulerComponent implements  OnInit{
  ...
  async  manipulate(){
    //Obtiene el dia de la semana del dia 1 del mes que se muestra.
    this.dayone = new Date(this.year, this.month, 1).getDay();
    console.log(new Date(this.year, this.month, 1))
    // Obtiene la fecha ultimo dia del mes que se muestra
