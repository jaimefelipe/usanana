...
export class FullComponent implements OnInit {
  ...
  AppPedido = false;
  ngOnInit() {
    localStorage.setItem('ToxoPOV','0');
  ...
  reportes(){
    this.route.navigate(['reporteventas']);
  }
    */
  ...
  ngOnInit() {
    ...
    this.accesosDirectos = [
      { titulo: 'Contactos', link: '/contactos', icon: '/assets/empleados.png' },
      { titulo: 'Articulos', link: '/articulos', icon: '/assets/inventario.png' },
      { titulo: 'Facturas', link: '/ventas', icon: '/assets/ventas.png' },
      { titulo: 'Compras', link: '/purchaseInvoice', icon: '/assets/compras.png' }
    ];
